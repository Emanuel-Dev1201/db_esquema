...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($usuario) {
        ...
        header('Location: /db_esquema/public/personas.php'); // o donde quieras dirigirlo
        exit;
    } else {
...
<div class="login-container">
    ...
    <div class="register-link">
        ¿No tienes una cuenta? <a href="/db_esquema/public/usuarios.php?accion=crear">Regístrate aquí</a>
    </div>
</div>
